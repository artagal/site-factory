...
export function Navbar() {
  return (
    <header className="sticky top-0 z-40 h-[var(--app-header-height)] border-b border-white/10 bg-[#070816]/92 backdrop-blur-2xl">
      <div className="mx-auto flex h-full max-w-7xl items-center justify-between gap-4 px-4 md:px-8">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2 lg:hidden">
          <ThemeToggle />
          <LinkButton className="min-h-11 rounded-full px-3 py-2 sm:px-4" href="/deals?when=tonight" showArrow={false}>
            Deals
          </LinkButton>
          <details className="relative">
            ...
            <div className="absolute right-0 top-full mt-2 w-64 rounded-2xl border border-white/10 bg-[#070816] p-2 shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
              {links.map((link) => (
