...
export const metadata: Metadata = buildSeoMetadata({
  ...
  description: "GoFunMotion privacy policy for the website, Firebase-ready accounts, saved plans, booking requests, partner applications, and waitlist data.",
  path: "/privacy"
});
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12 md:px-8 md:py-20">
      ...
      <div className="mt-8 grid gap-5 text-base leading-7 text-white/68">
        <p>GoFunMotion Deals lets visitors browse starter plan and deal experiences before signing in. Future Firebase features may store saved plans, saved listings, booking requests, preferences, partner applications, and profile details.</p>
